...
public:
    ...
    BouncingBall( ofPoint pos, ofVec2f speed , float size, ofColor col, ofImage* img,bool* useGridi,int* numCol,int* numRow,                
                 bool* useBorderi, bool* useTori,ofParameter<float>* gridForcei,ofParameter<float>* userForce,bool* insideModei, int* dieMode, int lifeTimein, ofPoint* poly, ofVec2f* speedcentroid, ofVec2f* gravityin );
